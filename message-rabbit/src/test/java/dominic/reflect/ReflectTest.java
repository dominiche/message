...
/**
 * Created by Administrator:herongxing on 2017/12/15 20:35.
 */
public class ReflectTest<T> {
    public ReflectTest(){}
    public <E> ReflectTest(E e){}
    ...
    public static void main(String[] args) throws Exception {
        ...
        instanceActualReflectTest(fieldGenericType);
        System.out.println();
        ...
        instanceActualReflectTest(genericReturnType);
        System.out.println();
        ...
        for (int i = 0; i < genericParameterTypes.length; i++) {
            ...
            instanceActualReflectTest(genericParameterTypes[i]);
        }
        System.out.println();
        ...
        for (int i = 0; i < constructorParameterTypes.length; i++) {
            ...
            instanceActualReflectTest(constructorParameterTypes[i]);
        }
        System.out.println();
    }
     ...
     * @throws Exception
     */
    private static void instanceActualReflectTest(Type type) throws Exception{
        ...
        if ( type instanceof ParameterizedType ) {
            ...
            // 参数化类型数组或类型变量数组也可以是多维的数组，getGenericComponentType()方法仅仅是去掉最右边的[]
                ...
                // 递归调用方法自身
                instanceActualReflectTest(componentType);
            }
